...
var vm = avalon
    .define({
        ...
        $restUrl : {
            querySdnControllerInfoUrl : '/api/roc/v1/resource/sdncontrollers',
            addSdnControllerInfoUrl : '/api/roc/v1/resource/sdncontrollers',
            updateSdnControllerInfoUrl : '/api/roc/v1/resource/sdncontrollers/',
            delSdnControllerInfoUrl : '/api/roc/v1/resource/sdncontrollers/'
        },
        $htmlText : {
