...
public class VTPScenarioResource extends VTPResource {
    ...
    public VTPTestScenarioList listTestScenariosHandler() throws VTPException {
        ...
        args.addAll(Arrays.asList(PRODUCT_ARG, OPEN_CLI, "product-list", FORMAT, "json"));
        ...
        if (results != null && results.isJsonArray() && results.getAsJsonArray().size() > 0) {
            ...
            for (Iterator < JsonElement > it = resultsArray.iterator(); it.hasNext();) {
                ...
                if (n.entrySet().iterator().hasNext()) {
                    ...
                    list.getScenarios()
                        .add(new VTPTestScenario().setName(name).setDescription(n.get(DESCRIPTION).getAsString()));
                }
            }
        }
    ...
    public Response listTestScenarios() throws VTPException {
        return Response.ok(this.listTestScenariosHandler().getScenarios().toString(), MediaType.APPLICATION_JSON)
            .build();
    }
    ...
    public VTPTestSuiteList listTestSutiesHandler(String scenario) throws VTPException {
        ...
        args.addAll(Arrays.asList(PRODUCT_ARG, OPEN_CLI, "service-list", PRODUCT_ARG, scenario, FORMAT, "json"));
        ...
        if (results != null && results.isJsonArray() && results.getAsJsonArray().size() > 0) {
            ...
            for (Iterator < JsonElement > it = resultsArray.iterator(); it.hasNext();) {
                ...
                JsonObject n = jsonElement.getAsJsonObject();
                if (n.entrySet().iterator().hasNext()) {
                    list.getSuites().add(new VTPTestSuite().setName(n.get(SERVICE).getAsString())
                        .setDescription(n.get(DESCRIPTION).getAsString()));
                }
            }
        }
    ...
    public Response listTestSuties(@ApiParam("Test scenario name") @PathParam("scenario") String scenario)
    throws VTPException {

        return Response.ok(this.listTestSutiesHandler(scenario).getSuites().toString(), MediaType.APPLICATION_JSON)
            .build();
    }
    ...
    public VTPTestCaseList listTestcasesHandler(String testSuiteName, String scenario) throws VTPException {
        ...
        args.addAll(Arrays.asList(PRODUCT_ARG, OPEN_CLI, "schema-list", PRODUCT_ARG, scenario, FORMAT, "json"));
        ...
        if (results != null && results.isJsonArray() && results.getAsJsonArray().size() > 0) {
            ...
            for (Iterator < JsonElement > it = resultsArray.iterator(); it.hasNext();) {
                ...
                JsonObject n = jsonElement.getAsJsonObject();
                if (n.entrySet().iterator().hasNext())
                    list.getTestCases().add(new VTPTestCase().setTestCaseName(n.get("command").getAsString())
                        .setTestSuiteName(n.get(SERVICE).getAsString()));
            }
        }
    ...
    public Response listTestcases(@ApiParam("Test scenario name") @PathParam("scenario") String scenario,
        @ApiParam("Test suite name") @QueryParam("testSuiteName") String testSuiteName) throws VTPException {

        return Response.ok(this.listTestcasesHandler(testSuiteName, scenario).getTestCases().toString(),
            MediaType.APPLICATION_JSON).build();
    }

    public VTPTestCase getTestcaseHandler(String scenario, String testSuiteName, String testCaseName)
    throws VTPException {
        List < String > args = new ArrayList < > ();
        args.addAll(Arrays.asList(PRODUCT_ARG, OPEN_CLI, "schema-show", PRODUCT_ARG, scenario, "--service",
            testSuiteName, "--command", testCaseName, FORMAT, "json"));
        JsonElement results = null;
        try {
            results = this.makeRpcAndGetJson(args);
        } catch (IOException e) {
        ...
        if (Objects.nonNull(results)) {
            ...
            if (inputsJson != null && inputsJson.isJsonArray()) {
                createTestCaseInputFromResponse(tc, inputsJson);
            }
    ...
    private void createTestCaseInputFromResponse(VTPTestCase tc, JsonElement inputsJson) {
    ...
    @ApiResponses(value = {
        @ApiResponse(code = HttpStatus.INTERNAL_SERVER_ERROR_500, message = "Failed to perform the operation", response = VTPError.class),
        @ApiResponse(code = HttpStatus.NOT_FOUND_404, message = "Test case does not exist", response = VTPError.class)
    })
    public Response getTestcase(@ApiParam("Test scenario name") @PathParam("scenario") String scenario,
        @ApiParam(value = "Test case name") @PathParam("testSuiteName") String testSuiteName,
        @ApiParam(value = "Test case name") @PathParam("testCaseName") String testCaseName) throws VTPException {

        return Response.ok(this.getTestcaseHandler(scenario, testSuiteName, testCaseName).toString(),
            MediaType.APPLICATION_JSON).build();
    }
    @Path("/scenarios")
    @POST
    ...
    public Response storageScenarios(@ApiParam(value = "file form data body parts", required = true) @FormDataParam("files") List < FormDataBodyPart > bodyParts) throws VTPException {
